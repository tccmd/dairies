			...
			<div class="container-fluid" id="contents" align="center">
				<div class="row">
					<div class="col-md-12">
						...
						<!-- 타이틀 div -->
						<div class="text-center" style="background-color: #fff; width: 80%; padding: 20px;">
				...
				<div class="row" style="background-color: #fff; width: 80%; padding: 3% 1% 2% 1%;">
					<div class="col-md-5">
						...
						<!-- <img alt="Bootstrap Image Preview" src="https://www.layoutit-studio.com/img/sports-q-c-140-140-3.jpg" /> -->
						<div class="carousel slide" id="carousel-713460">
							<ol class="carousel-indicators">
								<li data-slide-to="0" data-target="#carousel-713460" class="active">
								</li>
								<li data-slide-to="1" data-target="#carousel-713460">
								</li>
								<li data-slide-to="2" data-target="#carousel-713460">
								</li>
							</ol>
							...
							</div> <a class="carousel-control-prev" href="#carousel-713460" data-slide="prev"><span
									class="carousel-control-prev-icon"></span> <span class="sr-only">Previous</span></a> <a
								class="carousel-control-next" href="#carousel-713460" data-slide="next"><span
