		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="text-center"
					...
					<p style="font-size: 9pt; margin: 0px">CONTRIBUTION</p>
					<hr width="20px;" color="brown"
						style="height: 2px; margin: 7px auto 10px auto;">
					<h3 style="font-weight: bold;">
						<a href="/notice/openNoticeList.do" style="color: #000;">사회공헌 연혁</a>
					</h3>
				</div>
				<!-- 여기까지 타이틀 div -->
			</div>
						...
						<div class="media-body">
							...
							<div class="media mt-3">
								<a class="pr-3" href="#"><img
									...
									src="https://www.layoutit-studio.com/img/sports-q-c-64-64-2.jpg" /></a>
								<div class="media-body">
									<h5 class="mt-0">Nested media heading</h5>
									Cras sit amet nibh libero, in gravida nulla. Nulla vel metus
									scelerisque ante sollicitudin commodo. Cras purus odio,
