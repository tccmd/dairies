...
// 	var confmKey = "devU01TX0FVVEgyMDI0MTIzMDE0MjQyMzExNTM3MTY=";
...
function init() {
        ...
        if (inputYn !== "Y") {
            ...
            // opener가 유효하면 콜백 함수 호출
            if (window.opener && !window.opener.closed) {
                window.opener.jusoCallBack(roadAddrPart1, addrDetail, zipNo);
                window.close();
            } else {
