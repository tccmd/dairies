							...
							<div class="col-md-12">
								...
								<div class="row">
									...
									<div class="col-md-6 push-sm-3">
										<form role="form" class="form-inline" name="searchForm" method="get" action="/notice/search.do">
										...
										<div class="col-md-4">
											<div class="card">
												<a href="/notice/openNoticeDetail.do?noticeIdx=${num}">
													<c:forEach var="file" items="${file }">
														<c:if test="${file.noticeIdx eq list.noticeIdx}">
															<img class="card-img-top" t="Bootstrap Thumbnail First" width="100%"
												...
												<div class="card-block">
													...
													<p class="">
														<c:choose>
															<c:when test="${fn:length(list.contents) > 100}">
																${fn:substring(list.contents, 0, 100)}...
															</c:when>
															<c:otherwise>
																${list.contents}
															</c:otherwise>
