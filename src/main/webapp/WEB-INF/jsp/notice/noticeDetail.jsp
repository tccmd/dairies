					...
					<div class="container-fluid" id="contents" align="center">
						...
						<div class="row" style="background-color: #fff; width: 80%; padding: 3% 1% 2% 1%;">
							<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-6">
										<img alt="Bootstrap Image Preview" class="img-fluid"
								...
								<div class="row" style="padding-top: 10%;">
									<div class="col-md-6 text-left">
										<a href="/notice/openNoticeDetail.do?noticeIdx=${detail[1].noticeIdx}">이전글 - ${detail[1].title }</a>
									</div>
									<div class="col-md-6 text-right">
										<a href="/notice/openNoticeDetail.do?noticeIdx=${detail[2].noticeIdx}">다음글 - ${detail[2].title }</a>
									</div>
								</div>
								<!-- 여기까지 하단 row -->
							</div>
