								...
								<div class="row" style="padding: 7px;">
									<div class="col-md-12">
										<ul class="nav nav-pills">
											<li class="nav-item">
												<% String id=null; String num=null; if (session.getAttribute("id") !=null) { /* num=(String)
													session.getAttribute("num"); */ id=(String) session.getAttribute("id"); } if (id !=null) { %>
													<a class="nav-link active" href="/member/logout.do">
											...
											<% } %>
												<li><a class="nav-link dropdown-toggle" href="http://example.com" id="navbarDropdownMenuLink"
														data-toggle="dropdown" href="">
														<fmt:message key="costomerCenter" />
													</a>
													<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
														<a class="dropdown-item" href="/board/openBoardPage.do?pageNumber=0&perPage=4">
